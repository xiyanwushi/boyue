...
<link href="/Public/m/css/team.css" rel="stylesheet" type="text/css">
<header>
...
<section class="content">
	<div class="mjd-header cover-info" style="transform: translateY(0px);">
		<ul class="new-search-tab bdr-bom" id="search-bar">
			<li class="new-change-eleven active" _status="1" _count="<?php echo ($son[1]); ?>">
				<span>
					<a href="javascript:;">一级团队</a>
				</span>
			</li>
			<li class="new-change-eleven" _status="2" _count="<?php echo ($son[2]); ?>">
				<span>
					<a href="javascript:;">二级团队</a>
				</span>
			</li>
			<li class="new-change-eleven" _status="3" _count="<?php echo ($son[3]); ?>">
				<span>
					<a href="javascript:;">三级团队</a>
				</span>
			</li>
		</ul>
	</div>
	<div id="wrapper" style="overflow: hidden; left: 0px;">
		<div id="scroller" style="transform-origin: 0px 0px 0px; position: absolute; top: 0px; left: 0px;">
			<p class="ListNumber"><span id="son">您的1级有效会员共有：<?php echo ($son[1]); ?>人</span><span>，总分销奖(<?php echo ($separate); ?>)+总团队奖(<?php echo ($tward); ?>)=<?php echo ($separate+$tward); ?></span></p>
			<ul class="moreMessage orderCont mb-ol" id="orderlist"> 
...
<script>
	var son1 = "<?php echo ($son[1]); ?>";
		son2 = "<?php echo ($son[2]); ?>";
		son3 = "<?php echo ($son[3]); ?>";
</script>
<script type="text/javascript" src="/Public/m/js/team.js"></script>
</body>
</html>