				...
				<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
                    ...
                    <tbody>
						<tr>
							...
							<td>
								<select name="qrcode[]" default="<?php echo ($_CFG['level'][0]['dist']); ?>">
							...
							<td>
								<select name="ground[]" default="<?php echo ($_CFG['level'][0]['ground']); ?>">
									<option value="1">开启</option>
									<option value="0">关闭</option>
								</select>
							</td>
                    	...
                    	<?php if(is_array($_CFG['level'])): $i = 0; $__LIST__ = array_slice($_CFG['level'],1,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><input type="text" style="width:60px" name="valid[]" value="<?php echo ($vo["valid"]); ?>" /></td>
                            <td><input type="text" style="width:60px" name="team[]" value="<?php echo ($vo["team"]); ?>" /></td>
                            <td>
								<select name="have[]" default="<?php echo ($vo['have']); ?>">
									<option value="0">不允许</option>
									<option value="2">银牌代理</option>
									<option value="3">金牌代理</option>
							...
							<td>
								<select name="qrcode[]" default="<?php echo ($vo["dist"]); ?>">
									<option value="1">开启</option>
									<option value="0">关闭</option>
								</select>
							</td>
							...
							<td>
								<select name="ground[]" default="<?php echo ($vo['ground']); ?>">
									<option value="1">开启</option>
									<option value="0">关闭</option>
								</select>
							</td>
