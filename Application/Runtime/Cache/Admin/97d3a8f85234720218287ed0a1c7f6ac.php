...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">商户申请管理</h1>
            <span class="pagedesc">操作商城商户申请信息</span>
			...
			<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
				<thead>
					<tr>
						...
						<th class="head0">用户头像</th>
						<th class="head0">身份证正面照</th>
						<th class="head0">身份证反面照</th>
						<th class="head0">姓名</th>
						<th class="head0">电话</th>
						<th class="head0">详细地址</th>
				...
				<tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td><img src="<?php echo ($vo["headimg"]); ?>" style="width:50px;height:50px;"></td>
						<td><a href="<?php echo (complete_url($vo["sfz_a"])); ?>" data-lightbox="roadtrip"><img src="<?php echo (complete_url($vo["sfz_a"])); ?>" style="width:80px;height:50px;"></a></td>
						<td><a href="<?php echo (complete_url($vo["sfz_b"])); ?>" data-lightbox="roadtrip"><img src="<?php echo (complete_url($vo["sfz_b"])); ?>" style="width:80px;height:50px;"></a></td>
						<td><?php echo ($vo["true_name"]); ?></td>
						<td><?php echo ($vo["mobile"]); ?></td>
						<td><?php echo ($vo["address"]); ?></td>
						<td>
							<?php if($vo['ismch'] == 1): ?>待审核
							<?php elseif($vo['ismch'] == 2): ?>
								审核成功
							<?php else: ?>
								拒绝<?php endif; ?>
						</td>
						<td class="center">
							<?php if($vo['ismch'] == 1): ?><a href="<?php echo U('audio',array('id'=>$vo['id'],'ismch'=>2));?>">审核成功</a> | 
							<a href="<?php echo U('audio',array('id'=>$vo['id'],'ismch'=>-1));?>">拒绝</a>
							<?php else: ?>
							-<?php endif; ?>
						</td>
