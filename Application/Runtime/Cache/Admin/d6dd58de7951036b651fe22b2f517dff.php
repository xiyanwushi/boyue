    ...
    <div class="centercontent">
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
			...
			<div class="tableoptions">                    
				<form method="post">
					转出用户:
					<input type="text" name="self_id" value="<?php echo ($_GET['deposit_user']); ?>" placeholder="请输入用户编号" class="smallinput" style="width:100px;" />
					接受用户:
					<input type="text" name="user_id" value="<?php echo ($_GET['accept_user']); ?>" placeholder="请输入用户编号" class="smallinput" style="width:100px;" />
					操作时间:
			...
			<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
				<thead>
					<tr>
						...
						<th class="head1">转出用户</th>
						<th class="head0">接受用户</th>
						<th class="head0"><?php echo ($_site['points_name']); ?>额度</th>
						<th class="head0"><?php echo ($_site['points_name']); ?>类型</th>
				...
				<tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td><?php if($vo['type'] == 'cx_points'): ?>重销<?php echo ($_site['points_name']); else: echo ($_site['points_name']); endif; ?></td>
