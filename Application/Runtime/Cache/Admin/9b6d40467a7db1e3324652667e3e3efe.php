            ...
            <form class="stdform stdform2" method="post">
				...
				<table class="form-table" cellspacing="1" border="0">
					...
					<tr style="display:none" id="reson">
						...
						<td>
							<input type="text" name="reson" id="reson" value="<?php echo ($info["reson"]); ?>" class="smallinput" />
						</td>
					</tr>
				</table>
				...
				<p class="stdformbutton">
					...
					<input type="reset" class="reset radius2" value="取消" onclick="location.href=&#39;<?php echo U('Product/index',array('status'=>0));?>&#39;" />
				</p>
			</form>
