...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">领导奖励设置</h1>
            <span class="pagedesc">设置商城用户领导奖励的条件</span>
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
			...
			<div class="tableoptions">                    
				<button class="radius3" onclick="add_level();">添加设置</button>
			</div><!--tableoptions-->
            ...
            <form class="stdform stdform2" method="post">
				<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
                    <thead>
                        <tr>
                            <th rowspan="1" class="head1">分销团队最低最高区间</th>
							<th colspan="1" class="head1">领导奖比例(分销团队的总额百分比)</th>
							<th colspan="1" class="head1">操作</th>
						</tr>
                    </thead>
                    <tbody>
							<?php if(is_array($_reward_setting)): $i = 0; $__LIST__ = $_reward_setting;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								<td>
									<input type="text" style="width:100px" name="min[]" value="<?php echo ($vo["min"]); ?>" />
								</td>
								<td><input type="text" style="width:100px" name="lv[]" value="<?php echo ($vo["lv"]); ?>" /></td>
				...
				<script>
					function add_level(){
						//return false;
						html = '<tr>'
							   +' <td><input type="text" style="width:100px" name="min[]" value="" /></td>'
							   +' <td><input type="text" style="width:100px" name="lv[]" value="" /></td>'
							   +'<td><a href="javascript:;" onclick="del_level(this)">删除</a></td>'
							   +'</tr>';
				...
				<p class="stdformbutton">
					...
					<input type="button" class="back radius2" onclick="window.location.href=&#39;<?php echo U('index');?>&#39;" value="返回" />
				</p>
			</form>
