			...
			<table cellpadding="0" cellspacing="0" border="0" class="stdtable">
				<thead>
					<tr>
						<th>总营业额</th>
						<th>总余额</th>
						<th>总<?php echo ($_site['points_name']); ?></th>
						<th>微信支付总入账</th>
						<th>余额支付总入账</th>
						<th>今日营业额</th>
						<th>今日现金支付</th>
				...
				<tbody>
					<tr>
						...
						<td><?php echo ((isset($info['money_total']) && ($info['money_total'] !== ""))?($info['money_total']):0); ?></td>
						<td><?php echo ((isset($info['money_points_total']) && ($info['money_points_total'] !== ""))?($info['money_points_total']):0); ?></td>
						<td><?php echo ((isset($info["money_wxpay"]) && ($info["money_wxpay"] !== ""))?($info["money_wxpay"]):0); ?></td>
						<td><?php echo ((isset($info["money_moneypay"]) && ($info["money_moneypay"] !== ""))?($info["money_moneypay"]):0); ?></td>
