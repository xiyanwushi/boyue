...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            ...
            <span class="pagedesc">对用户进行增加，修改或者删除等操作</span>
        </div><!--pageheader-->
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
			<div class="tableoptions">                    
				<button class="radius3" onclick="location.href='<?php echo U('useredit');?>'">添加用户</button>
			</div><!--tableoptions-->
			<form action="<?php echo U('del');?>" method="post" id='productForm'>
				<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><?php echo get_admin_name($vo['role_id']);?></td>
							<td class="center">
								<if condition="$vo['status']">
								<a href="<?php echo U('useredit', 'id='.$vo['id']);?>">修改</a> | 
								<a href="<?php echo U('delUser', array('id'=>$vo['id'],'table'=>'admin'));?>" onclick="return confirm('你确实要删除这个用户吗？')">删除</a>
							</td>
