			...
			<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
				<thead>
					<tr>
						...
						<th class="head0">重销<?php echo ($_site['points_name']); ?>支付</th>
						<th class="head0">自有<?php echo ($_site['points_name']); ?>支付</th>
						<th class="head0">微信支付</th>
						<th class="head0">现金支付</th>
				...
				<tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td><?php echo ($vo["cxpointspay"]); ?></td>
						<td><?php echo ($vo["pointspay"]); ?></td>
						<td><?php echo ($vo["wxpay"]); ?></td>
						<td><?php echo ($vo["moneypay"]); ?></td>
