...
<div class="bodywrapper">
    ...
    <div class="centercontent">
            ...
            <h1 class="pagetitle">编辑申请商户协议</h1>
            <span class="pagedesc">请认真编辑申请商户协议信息</span>       
        </div><!--pageheader-->
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">			       
            <form class="stdform stdform2" method="post">
				...
				<table class="form-table" cellspacing="1" border="0">
					...
					<tr>
						<th class="title">协议</th>
						<td>
							<textarea name="info" id="info" class="longinput" style="min-width:400;margin: 0px; height: 500px; max-width:640px;"><?php echo ($_xy['info']); ?></textarea>
						</td>
					</tr>
				</table>
