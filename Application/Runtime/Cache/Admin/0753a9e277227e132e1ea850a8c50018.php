...
<div class="bodywrapper">
    ...
    <div class="centercontent">
            ...
            <span class="pagedesc">请认真编辑产品的各项信息，每个商户最多上传<?php echo ($_mch['mnums']); ?>个产品</span>       
        </div><!--pageheader-->
            ...
            <form class="stdform stdform2" method="post">
				...
				<table class="form-table" cellspacing="1" border="0">
					...
					<tr>
						...
						<td>
							<?php if(is_array($feature)): foreach($feature as $k=>$v): ?><label>
								<input type="checkbox" name="feature[]" <?php if(in_array($k,$info['feature'])): ?>checked<?php endif; ?> value="<?php echo ($k); ?>"  />
								<span style="font-size:14px;margin-right:2%;font-weight:bold;"><?php echo ($v); ?></span>
					...
					<tr>
						<th class="title">商品出售价<small>设置商品的购买价格，最大价格不能超过<?php echo ($_mch['mprice']); ?>元（包括积分）</small></th>
						<td>
					...
					<tr>
						<th class="title">商品购买所需积分
							<small>
								...
								则必须要用积分进行购买，
								若没有则需要付相同比例的金额，
								积分范围为总价的<?php echo ($mplv[0]); ?>%~<?php echo ($mplv[1]); ?>%
							</small>
						</th>
						<td>
					...
					<tr>
						<th class="title">返佣比例
							<small>
								...
								返佣比例范围<?php echo ($mseparate[0]); ?>%~<?php echo ($mseparate[1]); ?>%
							</small>
						</th>
						<td>
