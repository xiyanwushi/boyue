			...
			<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
				<thead>
					<tr>
						...
						<th class="head1">打款金额</th>
						<th class="head1">手续费(若积分，则手续费为积分)</th>
						<th class="head1">提现总额</th>
						<th class="head1">提现类型</th>
				...
				<tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td><?php echo ($vo["ext"]); ?></td>
						<td><?php echo ($vo["total"]); ?></td>
						<td><?php if($vo['type'] == 1): ?>余额提现<?php else: ?>积分提现<?php endif; ?></td>
						...
						<td class="center">
							...
							<a href="<?php echo U('Finance/pay', array('wid'=>$vo['id'],'user_id' => $vo['user_id'],'money' => $vo['money'], 'remark' => '平台提现'));?>">一键转账</a>	 |
