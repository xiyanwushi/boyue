...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">运费管理</h1>
            <span class="pagedesc">对各个地区运费进行增加，修改或者删除等操作</span>
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
			...
			<div class="tableoptions">                    
				<button class="radius3" onclick="location.href='<?php echo U('edit');?>'">添加运费设置</button>
			</div><!--tableoptions-->
				<div class="tableoptions">        
				<form method="post" id="form">
					
					省份:
					<input type="text" name="provice" value="<?php echo ($_GET['provice']); ?>" class="smallinput" style="width:300px;" />
			...
			<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
				<thead>
					<tr>
						...
						<th class="head1">首重(单位：kg)</th>
						<th class="head1">续重(单位：kg)</th>
						<th class="head0">操作</th>
					</tr>
				</thead>
				<tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						<td><?php echo ($vo["provice"]); ?></td>
						<td><?php echo ($vo["fkg"]); ?></td>
						<td><?php echo ($vo["ekg"]); ?></td>
						<td class="center">
